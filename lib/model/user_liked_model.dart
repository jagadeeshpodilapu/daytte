...
UserLikedToModel userLikedByModelFromJson(String str) => UserLikedToModel.fromJson(json.decode(str));

String userLikedByModelToJson(UserLikedToModel data) => json.encode(data.toJson());
...
class UserLikedToModel {
    ...
    factory UserLikedToModel.fromJson(Map<String, dynamic> json) => UserLikedToModel(
        message: json["message"],
