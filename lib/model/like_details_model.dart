...
LikeDetailsModel likeDetailsModelFromJson(String str) =>
    LikeDetailsModel.fromJson(json.decode(str));

String likeDetailsModelToJson(LikeDetailsModel data) =>
...
class LikeDetailsModel {
  ...
  factory LikeDetailsModel.fromJson(Map<String, dynamic> json) =>
      LikeDetailsModel(
